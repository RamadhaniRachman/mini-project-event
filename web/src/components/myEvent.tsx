              ...
              return (
                ...
                >
                  ...
                  <div className="md:w-1/2 p-8 flex flex-col justify-between">
                    ...
                    <button className="w-full py-4 bg-charcoal hover:bg-white/5 rounded-xl text-white font-bold transition-all border border-white/10 active:scale-95">
                      Kelola Event
                    </button>
                  </div>
                </div>
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto space-y-4">
                    ...
                    <button className="w-full py-3 bg-charcoal hover:bg-white/5 rounded-lg text-white font-bold text-sm transition-all border border-white/10">
                      Kelola Event
                    </button>
                  </div>
                </div>
